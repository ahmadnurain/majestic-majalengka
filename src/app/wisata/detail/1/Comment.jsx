import Author from "@/app/(dashboard)/berita/[id]/Author";
...
const Comment = () => {
  return (
    <div className="py-5 px-4 border mb-3 shadow-md">
      ...
      <p>Terasering Panyaweuyan merupakan kawasan wisata terasering yang mayoritas adalah tanaman bawang putih dan bawang merah. Terasering di Panyaweuyan berbeda dengan terasering di daerah lain di Indonesia yang biasanya sebuah sawah.</p>
