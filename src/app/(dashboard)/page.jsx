    ...
    <div>
      ...
      <div className="">
        <div className="py-16 text-center bg-[url('/welcome-bg2.png')] bg-center bg-no-repeat">
          <h1 className="text-3xl font-bold text-text-header uppercase">Selamat Datang Di Majalengka</h1>
        ...
        <div className="py-16 text-center bg-[url('/sorotan-bg.png')] bg-center bg-no-repeat">
          ...
          <p className="lg:w-1/2 mx-auto">Majalengka memiliki bermacam hal yang dapat dinikmati. Berikut adalah beberapa hal yang menjadi sorotan saat ini.</p>
        </div>
